...
if __name__ == '__main__':
    ...
    # print("Success")
#     topic = "Kang Ji-hwan"
#     atomic_facts = ["Kang Ji-hwan is a South Korean actor.", "He was born on February 20, 1987, in Seoul, South Korea."]
#     generation = """Kang Ji-hwan is a South Korean actor and singer who was born on February 20, 1987, in Seoul, South Korea. He debuted as a singer in 2005 under the name Kang Sung-joon, releasing the single ""Love is..."". He later changed his stage name to Kang Ji-hwan in 2010.
# Kang Ji-hwan began his acting career in 2006, appearing in the television series ""Supreme Family, Da Naerang."" He gained widespread recognition for his role in the 2010 series ""Cyrano Agency,"" which earned him several Best New Actor awards. He has since appeared in numerous dramas and films, including ""The Princess' Man"" (2011), ""The King's Doctor"" (2012), ""Oh My Ghostess"" (2015), and ""Father Is Strange"" (2017).
# Kang Ji-hwan is known for his versatility as an actor, able to play a wide range of roles. He is also praised for his good looks and charming personality, which have earned him a large following among fans.
# In addition to his acting and singing career, Kang Ji-hwan is also a military reserve officer and has served in the South Korean military since 2011. He was discharged from the military in 2013 after completing his mandatory service.
# Overall, Kang Ji-hwan is a talented and respected actor and singer in South Korea, known for his dedication to his craft and his commitment to serving his country."""
#     # def _get_score(self, topic, generation, atomic_facts, knowledge_source, cost_estimate=None):
#     knowledge_source = "enwiki-20230401"
#     fs.register_knowledge_source(knowledge_source)
#     print(fs._get_score(topic, generation, atomic_facts, knowledge_source=knowledge_source, cost_estimate=False))

    bio_facts_file_path = "../../FActScore/data/labeled/bio_facts_segs.json"
