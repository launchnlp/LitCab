...
with open(file_path, 'r') as f:
    data = json.load(f)
prompt_path = "../factuality_prompt/train_fever_factual_final.Llama-2-7b-hf.csv"
prompt_data = pd.read_csv(prompt_path)
prompts = prompt_data['prompt'].tolist()
topics = prompt_data['topic'].tolist()
topic2prompt = {}
for i in range(len(topics)):
    topic2prompt[topics[i]] = prompts[i]
...
demonstration_file = "/data/xin/ICLR_2024/factuality_prompt/demos.txt"
num_demos=5
demonstration=True
if demonstration:
...
names = data.keys()
store_hidden_states_file = "../factuality_prompt/" + "/" + model_name.split('/')[-1] + "_correct_wrong_hidden_states.pt"
store_logits_file = "../factuality_prompt" + "/" + model_name.split('/')[-1] + "_correct_wrong_logits.pt"
store_ids_file = "../factuality_prompt" + "/" + model_name.split('/')[-1] + "_correct_wrong_ids.pt"
