...
# model_gen_file = 'data/testllama-7b-hf_greedy_search_answers.reeval_investigate_noise.jsonl'
# model_gen_file = "triviaqa/validationllama-7b-hf_answers.reeval.jsonl"
# model_gen_file = 'factualityprompt/fever_factual_finalllama-7b-hf_answers.reeval_investigate_noise.jsonl'
# model_gen_file = '/data/xin/wiki_qa/data/test.llama-7b-hf_greedy_search_answers.reeval_investigate_noise.jsonl'
# model_gen_file = 'data/testllama-7b-hftemperature_1.0topp_0.5_answers.reeval.jsonl'
