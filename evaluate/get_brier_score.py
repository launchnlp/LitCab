...
if first_factor == "lex_sim" or first_factor == "semantic_entropy":
    ...
    elif first_factor == "semantic_entropy":
        first_factor_values = [(max(first_factor_values) - x) / (max(first_factor_values) - min(first_factor_values)) for x in first_factor_values]
